...
assignment_6_dataset$Survived <- factor(assignment_6_dataset$Survived) # We change this column for better data handling
...
```{r}
# Create a data table for Sue and Kate
Sue_Kate_data <- tibble(
  Passengerid = c(892, 893), # This is imaginary i will probably drop this
  ...
  SibSp = c(0,0),
  Parch = c (1,1),
  Ticket = c (001,002), # This is imaginary i will probably drop this
  Fare = c(8, 8),
