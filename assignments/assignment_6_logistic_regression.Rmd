...
```{r}
model <- glmer(Survived ~ SibSp + Parch + (1 | Pclass) + (1 | Sex) + (1 | Age) + (1 | Fare) + (1 | Cabin) + (1 | Embarked), # I excluded Passengerid and Ticket name. The other variables are added as random effects.
...
accuracy <- mean(predictions == assignment_6_dataset$Survived) * 100
